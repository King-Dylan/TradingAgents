...
- If prior conservative or neutral arguments exist, respond to their strongest claims one by one. For each disputed issue, include: opposing claim, your rebuttal, supporting evidence or number, what risk remains, and why the aggressive path still wins or should be sized differently.
