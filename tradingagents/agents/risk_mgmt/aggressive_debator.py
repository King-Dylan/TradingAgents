...
- If prior conservative or neutral arguments exist, respond to the 4-6 most material current disputes, prioritizing the newest and strongest claims rather than replaying the entire history. For each disputed issue, include: opposing claim, your rebuttal, supporting evidence or number, what risk remains, and why the aggressive path still wins or should be sized differently.
